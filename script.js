...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    window.displayKdramas = function () {
        ...
        menus.forEach(menu => {
            ...
            card.onclick = () => {
                ...
                if (menu.id === "all") {
                    window.showAllDramas();
                }

                else if (menu.id === "genre") {
                    window.showGenresMenu();
                }

                else if (menu.id === "actor") {
                    window.showActorsMenu();
                }

                else if (menu.id === "year") {
                    window.showYearsMenu();
                }
    ...
    window.showActorsMenu = function (
        searchTerm = ""
    ) {
        ...
        actorList
            ...
            .forEach(actor => {
                ...
                const age =
                    calculateAge(info.bday);

                const card =
                    document.createElement("div");

                card.className =
                    "menu-card actor-card animate-in";

                card.innerHTML = `
                    ${info.photo}actor-menu-photo"
                        alt="${actor}">
    ...
    window.showFilteredDramas = function (
        value,
        type
    ) {
        ...
        kdramaData
            .filter(drama => {
                ...
                if (type === "year") {
                    return drama.year === value;
                }

                if (type === "genre") {
                    return drama.genre &&
                           drama.genre.includes(value);
                }

                if (type === "actor") {
                    return drama.cast &&
                           drama.cast.includes(value);
                }
    ...
    window.createDramaCard = function (
        drama
    ) {
